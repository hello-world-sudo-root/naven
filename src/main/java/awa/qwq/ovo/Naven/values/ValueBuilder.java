...
public class ValueBuilder {
   ...
   private String[] addonsModes;
   private boolean[] defaultSelectedAddons;
   ...
   public ValueBuilder setAddonsModes(String... modes) {
      if (this.valueType == null) {
         this.setValueType(ValueType.ADDONS);
      }

      if (this.valueType != ValueType.ADDONS) {
         throw new IllegalStateException("Value type is not addons");
      } else {
         this.addonsModes = modes;
         return this;
      }
   }

   public ValueBuilder setDefaultSelectedAddons(boolean... defaultSelected) {
      if (this.valueType == null) {
         this.setValueType(ValueType.ADDONS);
      }
      ...
      if (this.valueType != ValueType.ADDONS) {
         ...
         this.defaultSelectedAddons = defaultSelected;
         return this;
      }
   }
   ...
   public Value build() {
      if (this.valueType == null) {
         ...
         switch (this.valueType) {
            ...
            case ADDONS:
               if (this.addonsModes == null) {
                  throw new IllegalStateException("Addons modes are not set");
               }
               if (this.defaultSelectedAddons == null) {
                  this.defaultSelectedAddons = new boolean[this.addonsModes.length];
               }

               return new AddonsValue(this.key, this.name, this.addonsModes, this.defaultSelectedAddons, this.update, this.visibility);
            default:
