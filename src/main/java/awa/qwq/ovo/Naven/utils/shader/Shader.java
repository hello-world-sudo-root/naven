...
public class Shader {
    ...
    public Shader(String vertPath, String fragPath) {
        ...
        GlStateManager.glShaderSource(vert, Collections.singletonList(read(vertPath)));
        ...
        GlStateManager.glShaderSource(frag, Collections.singletonList(read(fragPath)));
    ...
    public void setDefaults() {
        ...
        set("u_ModelView", RenderSystem.getModelViewMatrix());
    }
}
